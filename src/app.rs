    ...
    fn process_action(&mut self, action: &ButtonAction) {
        match action {
            ...
            ButtonAction::CountChars => {
                self.output_text = format!("Length: {} chars", self.input_text.len());
            }
        }
    }
}
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.vertical_centered(|ui| {
                ui.heading(egui::RichText::new("HELLO WORLD").size(28.0).color(egui::Color32::WHITE));
                ui.add_space(20.0);
                ui.label(egui::RichText::new("Simple Text Processor").size(16.0).color(egui::Color32::from_gray(180)));
                ui.add_space(40.0);
            ...
            egui::Window::new("Keyboard")
                ...
                .show(ctx, |ui| {
                    ui.vertical_centered(|ui| {
                        ...
                        ui.add_space(12.0);
                        ui.horizontal(|ui| {
                            let del_btn = egui::Button::new("⌫ HAPUS")
                            ...
                            let close_btn = egui::Button::new("✓ TUTUP")
